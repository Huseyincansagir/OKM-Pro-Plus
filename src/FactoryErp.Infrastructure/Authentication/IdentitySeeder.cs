    ...
    PasswordHasher passwordHasher)
{
    ...
    private async Task EnsureSystemAdminPermissionsAsync(CancellationToken cancellationToken)
    {
        ...
        var definitions = new[]
        {
            ...
            ("10000000-0000-0000-0000-000000000072", "barcode.resolve", "warehouse", "resolve"),
            ("10000000-0000-0000-0000-000000000073", "stock-count.read", "warehouse", "read"),
            ("10000000-0000-0000-0000-000000000074", "stock-count.manage", "warehouse", "manage"),
